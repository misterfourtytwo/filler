# Konstruktor Project Code Guide - Explained Like You're 5! 🎨

## What is Konstruktor? 

Imagine you have a coloring book, but instead of just coloring with crayons, you can draw cool patterns like stars, circles, zigzags, and even rotate them! That's what Konstruktor is - a digital pixel art studio where you can create beautiful patterns on a grid.

## The Big Picture - How Everything Works Together 🌟

Think of Konstruktor like a big toy box with different compartments:
